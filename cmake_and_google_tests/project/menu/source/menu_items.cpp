...
const mmh::MenuItem mmh::DATA_BASE = {
    "1 - базы данных", mmh::data_base, &mmh::STUDY_OTHER_TECHNOLOGIES };
const mmh::MenuItem mmh::MULTISTREAM_PROG = {
    "2 - многопоточное программирование", mmh::multistream_prog, &mmh::STUDY_OTHER_TECHNOLOGIES };
const mmh::MenuItem mmh::WEB_TECH = {
    "3 - сетевые технологии", mmh::web_tech, &mmh::STUDY_OTHER_TECHNOLOGIES };
const mmh::MenuItem mmh::OTHER_GO_BACK = {
    "0 - выход в предыдущее меню", mmh::go_back, &mmh::STUDY_OTHER_TECHNOLOGIES };
...
const mmh::MenuItem mmh::STUDY_OTHER_TECHNOLOGIES = {
    "3 - другие технологии", mmh::show_menu, &mmh::STUDY, other_children, other_size };
const mmh::MenuItem mmh::STUDY_GO_BACK = {
    "0 - выйти в главное меню", mmh::go_back, &mmh::STUDY };
